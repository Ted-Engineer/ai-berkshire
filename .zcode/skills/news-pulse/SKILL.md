...
This skill is generated from `skills/news-pulse.md` so Claude Code, Codex, TRAE, DSH, and ZCode users share one canonical workflow. ZCode discovers it as a workspace skill at `.zcode/skills/news-pulse/SKILL.md` (project-level, scanned before `.agents/skills`).
