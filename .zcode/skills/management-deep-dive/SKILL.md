...
This skill is generated from `skills/management-deep-dive.md` so Claude Code, Codex, TRAE, DSH, and ZCode users share one canonical workflow. ZCode discovers it as a workspace skill at `.zcode/skills/management-deep-dive/SKILL.md` (project-level, scanned before `.agents/skills`).
