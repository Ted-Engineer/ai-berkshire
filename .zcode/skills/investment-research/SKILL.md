...
This skill is generated from `skills/investment-research.md` so Claude Code, Codex, TRAE, DSH, and ZCode users share one canonical workflow. ZCode discovers it as a workspace skill at `.zcode/skills/investment-research/SKILL.md` (project-level, scanned before `.agents/skills`).
