...
This skill is generated from `skills/private-company-research.md` so Claude Code, Codex, TRAE, DSH, and ZCode users share one canonical workflow. ZCode discovers it as a workspace skill at `.zcode/skills/private-company-research/SKILL.md` (project-level, scanned before `.agents/skills`).
