"""Shared per-skill Chinese descriptions (what + when-to-invoke).

Single source of truth for the DSH/ZCode/Qoder/Codex generators.
TRAE intentionally keeps its own fullwidth-punctuation variant in
sync-trae-skills.py.
New skill => add one entry here, or every runtime falls back to a
content-free description (the daily-brief TRAE bug).
"""
