...
- `.zcode/skills/*/SKILL.md`: ZCode workspace-level skills. Generated from
  ...
  workspace level).
- `.qoder/skills/*/SKILL.md`: Qoder project-level skills — the path Qoder
  actually discovers (no registration needed). Contains the 22 investment
  skills generated by `scripts/sync-qoder-skills.py` (do not edit manually)
  plus hand-written Qoder-only skills (e.g. `repo-health-audit`).
- `.qoder/plugins/ai-berkshire-investment/skills/*/SKILL.md`: Qoder plugin
  mirror of the same 22 skills, generated from `skills/*.md`; do not edit
  manually. Kept for plugin packaging and the `hooks/` it ships; skill
  discovery runs through `.qoder/skills/`, not the plugin dir.
...
- `scripts/sync-qoder-skills.py`: regenerates Qoder skills from `skills/*.md`
  into `.qoder/skills/` (discovery path) and the
  `.qoder/plugins/ai-berkshire-investment/skills/` mirror.
