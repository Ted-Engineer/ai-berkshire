...
This skill is generated from `skills/management-deep-dive.md` so Claude Code, Codex, TRAE, and DSH users share one canonical workflow. DSH discovers it as a project-level skill at `.dsh/skills/management-deep-dive/SKILL.md` (rank 100, highest local priority).
