...
This skill is generated from `skills/earnings-review.md` so Claude Code, Codex, TRAE, and DSH users share one canonical workflow. DSH discovers it as a project-level skill at `.dsh/skills/earnings-review/SKILL.md` (rank 100, highest local priority).
