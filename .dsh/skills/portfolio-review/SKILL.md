...
This skill is generated from `skills/portfolio-review.md` so Claude Code, Codex, TRAE, and DSH users share one canonical workflow. DSH discovers it as a project-level skill at `.dsh/skills/portfolio-review/SKILL.md` (rank 100, highest local priority).
