...
This skill is generated from `skills/investment-team.md` so Claude Code, Codex, TRAE, and DSH users share one canonical workflow. DSH discovers it as a project-level skill at `.dsh/skills/investment-team/SKILL.md` (rank 100, highest local priority).
