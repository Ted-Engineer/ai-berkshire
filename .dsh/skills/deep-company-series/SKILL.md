...
This skill is generated from `skills/deep-company-series.md` so Claude Code, Codex, TRAE, and DSH users share one canonical workflow. DSH discovers it as a project-level skill at `.dsh/skills/deep-company-series/SKILL.md` (rank 100, highest local priority).
