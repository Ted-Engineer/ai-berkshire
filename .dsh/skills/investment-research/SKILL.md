...
This skill is generated from `skills/investment-research.md` so Claude Code, Codex, TRAE, and DSH users share one canonical workflow. DSH discovers it as a project-level skill at `.dsh/skills/investment-research/SKILL.md` (rank 100, highest local priority).
