---
name: quality-screen
description: "去劣筛选：7条指标快速排除非一流公司。当用户想快速筛选股票池、排除烂公司或平庸公司时调用。"
---

## TRAE adapter note

This skill is generated from `skills/quality-screen.md` so Claude Code, Codex, and TRAE users share one canonical workflow.
