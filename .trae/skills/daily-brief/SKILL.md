---
name: daily-brief
description: "AI Berkshire 投研技能：daily-brief"
---

## TRAE adapter note

This skill is generated from `skills/daily-brief.md` so Claude Code, Codex, and TRAE users share one canonical workflow.
